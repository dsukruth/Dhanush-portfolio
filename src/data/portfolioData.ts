...
export const projects = [
  {
    ...
    features: [
      ...
      "94% prediction accuracy through advanced feature engineering",
      "MLOps infrastructure with ZenML and MLflow",
      "Docker containerization and REST API deployment",
